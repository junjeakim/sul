  ...
  const products = [
    {
      ...
      image: require("../images/wine/moutoncadet_re.png"),
      description: [
    ...
    },
    {
      ...
      image: require("../images/wine/moutoncadet_sauvignon.png"),
      description: [
    ...
    },
    {
      ...
      image: require("../images/wine/moutoncadet_heretigi.png"),
      description: [
    ...
    },
    {
      ...
      image: require("../images/wine/los_vascos.png"),
      description: [
    ...
    },
    {
      ...
      price: "35,000원",
      originalPrice: "40,000원",
      image: require("../images/wine/los_vascos_blang.png"),
      description: [
    ...
    },
    {
      ...
      image: require("../images/wine/los_vascos_thato.png"),
      description: [
        "로스 바스코스 샤도네이는<br>",
        "신선하고 상쾌한 맛과 함께<br>",

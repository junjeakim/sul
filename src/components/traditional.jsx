  ...
  const products = [
    {
      ...
      image: require("../images/traditional/goundal_white.jpg"),
      description: [
    ...
    },
    {
      ...
      price: "324,000원",
      originalPrice: "400,000원",
      image: require("../images/traditional/houndal_oak.jpg"),
      description: [
    ...
    },
    {
      ...
      image: require("../images/traditional/hongju.png"),
      description: [
    ...
    },
    {
      ...
      image: require("../images/traditional/hansan.png"),
      description: [

         ...
         <div className="board-page">
            ...
            <table className="post-table">
               ...
               <tbody>
                  {inquiries.map((inquiry) => (
                     <tr key={inquiry.id}>
                        <td onClick={() => setSelectedInquiry(inquiry)} style={{ cursor: 'pointer' }}>
                           {inquiry.title}
                        </td>
                        ...
                        <td>
                           <button onClick={() => handleDelete(inquiry.id)} className="delete-btn">
                              삭제
                           </button>
                        </td>
                     </tr>
            ...
            {isWriting && (
               <form onSubmit={handleSubmit} className="write-form">
                  ...
                  <textarea placeholder="내용" value={content} onChange={(e) => setContent(e.target.value)} required></textarea>

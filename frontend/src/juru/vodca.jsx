...
const VodkaPage = () => {
    ...
    const fetchProducts = async () => {
      try {
        const response = await axios.get(
          "http://localhost:8081/api/products?category=vodka"
        );
        setProducts(
          response.data.filter((product) => product.category === "vodka")
        );
        console.log("Vodka products:", response.data); // 디버깅 로그 추가
      } catch (error) {
  ...
  return (
    <div className="product-page">
      <img
        src={require("../images/bodca/Vodka Wyborowa Design.012 copy.jpg")} // 경로 수정
        alt="Main Product"
            ...
            <div className="modal-right">
              ...
              <div className="modal-buttons">
                ...
                <button
                  ...
                  onClick={() => addToCart(modalContent.subject, "userId")}
                >
                  장바구니 추가
                </button>

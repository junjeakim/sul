      ...
      <div className="main-content">
        ...
        <div className="my-page-buttons">
          ...
          <button
            ...
            onClick={() => setCurrentView("couponHistory")}
          >
            쿠폰내역
          </button>
          <button
            className="coupon-registration"
            onClick={() => setCurrentView("couponRegistration")}
          >
            쿠폰등록
          </button>
          <button
